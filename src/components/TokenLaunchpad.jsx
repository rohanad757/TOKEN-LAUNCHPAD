...
export function TokenLaunchpad() {
    ...
    <div class="form-group">
        <input class="inputText" type="text" placeholder="Token Name" />
        <input class="inputText" type="text" placeholder="Token Symbol" />
        <input class="inputText" type="text" placeholder="Image URL" />
        <input class="inputText" type="number" placeholder="Initial Supply" min="1" />
    ...
    <button onClick={createToken} class="btn">Create Token</button>
</body>
}